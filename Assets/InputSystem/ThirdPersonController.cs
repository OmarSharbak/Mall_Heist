 ...
 */
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public EscalatorManager escalatorManager;
        ...
        private void Awake()
        {
            ...
            if (_mainCamera == null)
            {
                ...
                Transform mainCameraTransform = playerParent.Find("MainCamera");
    ...
    [SerializeField] private CinemachineVirtualCamera FullMapCinemachineCamera;
    bool fullMap = false;
    ...
    private void StopGrassHiding()
    {
        ...
        [SerializeField] GameObject resumeButtonGameObject;
