...
;
		...
		public virtual bool RemoveItem(int i, int quantity)
		{
			...
			if (Content[i].Quantity <= 0)
			{
				...
				MMInventoryEvent.Trigger(MMInventoryEventType.ContentChangedRemovedLast, null, this.name, null, 0, i, PlayerID);
				return suppressionSuccessful;
			}
			else
			{
				MMInventoryEvent.Trigger(MMInventoryEventType.ContentChangedRemoved, null, this.name, null, 0, i, PlayerID);
				return true;
			}
		}
		...
		public void FillSerializedInventory(SerializedInventory serializedInventory)
		{
		...
		/// </summary>
		/// <param name="serializedInventory">Serialized inventory.</param>
		public void ExtractSerializedInventory(SerializedInventory serializedInventory)
		{
