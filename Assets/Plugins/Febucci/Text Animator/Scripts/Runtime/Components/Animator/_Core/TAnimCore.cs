...
namespace Febucci.UI.Core
{
    ...
    public abstract class TAnimCore : MonoBehaviour
    {
        ...
        /// </summary>
        /// <param name="isCategoryEnabled"></param>
        public void SetBehavioursActive(bool isCategoryEnabled) => isAnimatingAppearances = isCategoryEnabled;
        ...
        public void EnableAppearancesLocally(bool value) => SetBehavioursActive(value);
