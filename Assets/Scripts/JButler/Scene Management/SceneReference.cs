...
// http://answers.unity.com/answers/1541867/view.html
// Note: I updated script with 2 additional getters: SceneName & BuildIndex
    ...
    public class SceneReference : ISerializationCallbackReceiver
    {
        ...
        public int BuildIndex
        {
            get
            {
                ...
                {
                    if (UnityEngine.SceneManagement.SceneUtility.GetScenePathByBuildIndex(i) == ScenePath) return i;
                }
                return -1;
            }
        }
